...
<body id="page-top" class="index"  ng-app="myhome">
	...
	<section class="paddIngZero" style="margin-top:80px">
        <div class="container">
		<h1 class="text-success bg-sucess well well-sm text-center">Bollywood</h1>		
...
if(isset($_POST['submitform'])){	
	...
	$target_dir = "uploads/bw/original/";
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
		...
		createThumbs("uploads/bw/original/","uploads/bw/thumb/",300,'');
		createThumbs("uploads/bw/original/","uploads/bw/thumb_2/",200,'');
		createThumbs("uploads/bw/original/","uploads/bw/thumb_3/",170,'');
		createThumbs("uploads/bw/original/","uploads/bw/thumb_4/",45,'');
    } else {
