...
<body id="page-top" class="index"  ng-app="myhome">
	...
	<div class="col-md-12">
        <h3 class="text-success bg-sucess well well-sm text-center">Tollywood List</h3>		
        <div class="table-responsive">
			<a href="tw.php" title="" class="btn btn-primary btn-md pull-right"  >&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-plus-sign"></span> &nbsp;New&nbsp;&nbsp;&nbsp;&nbsp;</a>
